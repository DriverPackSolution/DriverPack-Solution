	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'tools/ico/infobar/progress/progressbar.gif', 					// boxImage : image around the progress bar
				barImage		: {
									0:  'tools/ico/infobar/progress/progressbg_red.gif',
									30: 'tools/ico/infobar/progress/progressbg_orange.gif',
									70: 'tools/ico/infobar/progress/progressbg_green.gif'
								},
			...
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					var t = function() {
						...
						//alert(config.value);
if ((config.running_value>100) && (!progressBar_wait)) { progressBar_wait=true; return false; }
						if ((config.running_value == config.value) || (config.value != progressBar_target))
							return false;
						...
						setTimeout(t,progressBar_speed);
						pb.config = config;
					};
					setTimeout(t,progressBar_speed);
				});
